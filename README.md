...
A checked-in screen-space snapshot generated by Maps from its committed E2E style fixture. The snapshot contains resolved paint plus projected line/simple-polygon geometry only. Geographic coordinates, camera state, tile identity and style evaluation remain outside this repository. The disposable adapter fails closed for Maps circles, direction markers and polygon holes rather than approximating them.
